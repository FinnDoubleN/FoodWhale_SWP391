<%-- 
    ...
    Created on : Dec 4, 2021, 4:55:54 PM
    Author     : Asus
--%>
                        ...
                        <div class="product-detail-container">
                            <div class="product-common">
                                <div class="photo-container">
                                    <div class="photo-box">
                                        <div class="main-photo">
                                            <div class="avaBox">
                                                <img class="img-fit" src="<%= in.getImage()%>"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="package-info">
                                    <div class="basic-info-box">
                                        <h1 class="names"><%= in.getInName()%></h1>
                                        <div class="stat">
                                            <div class="type"><%= in.getcName()%></div>
                                        </div>
                                        <div class="price-x">
                                            <div class="price">
                                                <div>
                            ...
                            <div class="product-desc">
                                ...
                                <div class="content-box">
                                    <div class="content">
                                        <div class="content-x"><%= in.getDescription()%></div>
                                    </div>
                                    <div class="content active">
                                        <ul class="rc-steps-box">
                                            <li>
                                                <div><%= in.getGuideline()%></div>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
