...
<html lang="en">
    ...
    <body class="app">
                        ...
                        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                            ...
                            <li class="nav-item has-submenu">
                                <a class="nav-link submenu-toggle active" href="#">
                                    ...
                                    <span class="nav-link-text">Categories Detail</span>
        ...
        <div class="app-wrapper">
            <div class="app-content pt-3 p-md-3 p-lg-4" style="height: 630px;">
                                    ...
                                    <div class="item border-bottom py-3">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <input type="textarea" class="item-data" value="<%= c.getDescription()%>" name="Description">
                                            </div>
                                        </div>
                                    </div>
