<%-- 
    Document   : IngredientListDetail
    Created on : Dec 11, 2021, 5:33:49 PM
    Author     : ADMIN
--%>
        ...
        <div class="app-wrapper">
            <div class="app-content pt-3 p-md-3 p-lg-4">
                <div class="container-xl">
                    <h1 class="app-page-title">Ingredient Detail</h1>
                    <div class="row-new gy-4">
                        <div class="col-12 col-lg-12">
                            ...
                            <form class="app-card app-card-account shadow-sm d-flex flex-column" action="IngredientListDetail" method="post">
                                <div class="app-card-body px-4 col-12 col-lg-6">
                                    <input type="hidden" class="item-data" value="<%= in.getInID()%>" name="inID" readonly>
                                    ...
                                    <div class="item border-bottom py-3">
                                        <div class="row justify-content-between align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <input type="text" class="item-data" value="<%= in.getType()%>" name="Type">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item border-bottom py-3">
                                    ...
                                    <div class="item border-bottom py-3">
                                        <div class="row justify-content-between">
                                            <div class="col-auto">
                                                ...
                                                <% if (in.getStatus().equalsIgnoreCase("Active")) {%>
                                                <input type="radio" id="Active" name="status" value="Active" checked>
                                                <label for="Active">Active</label>
                                                <input type="radio" id="Delete" name="status" value="Delete">
                                                <label for="Delete">Delete</label>
                                                <%} else if (in.getStatus().equalsIgnoreCase("Delete")) {%>
