<%-- 
    Document   : CategoryRecipe
    Created on : Dec 14, 2021, 4:11:02 PM
    Author     : Asus
--%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cell">
                                                        <form action="CategoryList" method="post">
                                                            ...
                                                            <input class="btn-sm app-btn-secondary" name="submitR" type="submit" value="View">
                                                            <%
                                                                if (c.getStatus().equalsIgnoreCase("Active")) {
                                                            %>
                                                            <input class="btn-sm app-btn-secondary" name="submitR" type="submit" value="Delete">
                                                            <%} else { %>
                                                            <input class="btn-sm app-btn-secondary" name="submitR" type="submit" value="Active">
                                                            <%}%>
                                                        </form>
                                                    </td>
                                                </tr>
